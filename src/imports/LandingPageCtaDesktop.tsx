    ...
    <Wrapper>
      ...
      <div className="content-stretch flex gap-[3.133px] items-start relative shrink-0">
        <div className="relative rounded-[80px] shrink-0" data-name="Label">
          ...
          />
          <Wrapper1>
            <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#ffb836] text-[5.48px]">
              {"Marketing"}
            </p>
          </Wrapper1>
        </div>
...
function LabelText({ text }: LabelTextProps) {
  return (
    <div className="relative rounded-[80px] shrink-0">
      ...
      />
      <Wrapper1>
        <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#4640de] text-[5.48px]">
          {text}
        </p>
      </Wrapper1>
    </div>
...
function Location({ text, text1 }: LocationProps) {
  return (
    <div className="content-stretch flex gap-[3.133px] items-center justify-center relative shrink-0">
      <p className="font-['Epilogue:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#7c8493] text-[6.27px]">
        {text}
      </p>
...
function LandingPageCtaDesktopJobTitle({
  ...
  return (
    <div className="content-stretch flex flex-col gap-[0.783px] items-start relative shrink-0">
      <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#25324b] text-[7.05px]">
        {text}
      </p>
...
function Text({ text, additionalClassNames = "" }: TextProps) {
  return (
    ...
    >
      <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#56cdad] text-[5.48px]">
        {text}
      </p>
    </div>
  );
    ...
    <div className={clsx("relative shrink-0", additionalClassNames)}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[4.7px] py-[2.742px] relative">
          <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#4640de] text-[6.27px]">
            {text}
          </p>
        </div>
      </div>
          ...
          <div className="bg-white relative shrink-0" data-name="Button">
            <div className="flex flex-row items-center justify-center size-full">
              <div className="content-stretch flex items-center justify-center px-[24px] py-[12px] relative">
                <p className="font-['Epilogue:Bold',sans-serif] font-bold leading-[1.6] relative shrink-0 text-[#4640de] text-[16px] text-center">
                  Sign Up For Free
                </p>
              </div>
            </div>
              ...
              <div className="content-stretch flex flex-col items-start justify-between py-[12.533px] relative size-full">
                ...
                >
                  ...
                  >
                          ...
                          >
                            <g id="Vector 7">
                              ...
                              <path
                                ...
                                mask="url(#path-1-inside-1_1_4138)"
                              />
                            </g>
                          </svg>
                        </div>
                    ...
                    <p
                      className="font-['Red_Hat_Display:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#202430] text-[9.4px] tracking-[-0.094px]"
                      style={{ fontFeatureSettings: "'cv11'" }}
                    >
                      QuickHire
                    </p>
                  ...
                  >
                    ...
                    >
                      <div className="content-stretch flex items-start pl-[12.533px] relative shrink-0">
                        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[9.4px] not-italic opacity-50 relative shrink-0 text-[#202430] text-[5.48px] tracking-[0.2192px]">
                          SETTINGS
                        </p>
                      </div>
                      <div
                ...
                <div className="content-stretch flex items-center justify-between px-[12.533px] py-[6.267px] relative w-full">
                  ...
                  >
                    ...
                    <div
                      ...
                      data-name="Job Title"
                    >
                      <p className="font-['Epilogue:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#515b6f] text-[6.27px]">
                        Company
                      </p>
                      <div className="content-stretch flex gap-[3.133px] items-start relative shrink-0">
                        <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[#25324b] text-[7.83px]">
                          Nomad
                        </p>
                        <div
                    ...
                    >
                      <div className="flex flex-row items-center justify-center size-full">
                        <div className="content-stretch flex gap-[3.917px] items-center justify-center px-[9.4px] py-[4.7px] relative">
                          ...
                          <p className="font-['Epilogue:Bold',sans-serif] font-bold leading-[1.6] relative shrink-0 text-[6.27px] text-center text-white">
                            Post a job
                          </p>
                        </div>
                      </div>
              ...
              >
                ...
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between px-[6.267px] py-[4.7px] relative w-full">
                    <p className="font-['Epilogue:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#25324b] text-[6.27px]">
                      Jul 19 - Jul 25
                    </p>
                    <div
                      className="overflow-clip relative shrink-0 size-[7.833px]"
                ...
                >
                  <div className="content-stretch flex items-start justify-between p-[9.4px] relative w-full">
                    ...
                    <div
                      ...
                      data-name="Button"
                    >
                      <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#4640de] text-[6.267px]">
                        View All
                      </p>
                      <div
                        className="relative shrink-0 size-[9.4px]"
                  ...
                  <div className="content-stretch flex gap-[9.4px] items-start p-[9.4px] relative w-full">
                    ...
                    <JobList1>
                      ...
                      <div
                        ...
                        data-name="Job Title"
                      >
                        <p className="font-['Epilogue:SemiBold',sans-serif] font-semibold leading-[1.6] relative shrink-0 text-[#25324b] text-[2.76px]">
                          Product Designer
                        </p>
